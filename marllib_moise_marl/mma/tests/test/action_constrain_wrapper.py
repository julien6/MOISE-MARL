...
from mma_wrapper.organizational_model import obligation, organizational_model, permission
from mma_wrapper.deontic_specifications_ttl import deontic_specifications_ttl
from mma_wrapper.utils import OBLIGATION_REWARD_FACTOR


class RLlibMPE_action_wrapper(MultiAgentEnv):
